let _show_view=({id, name, image_url, description, price, special_price,})=>{
	...
	$product.append($(`<span>Цена: ${price}</span>`));
	$product.append($(`<button type"button"class="">Приобрести</button>`));
	return $product;
};
